...
/// he needs you to bring him measurements from _fifty stars_.
///
...
/// three, round down, and subtract 2\. However, that fuel _also_ requires fuel,
/// and _that_ fuel requires fuel, and so on. Any mass that would require
/// _negative fuel_ should instead be treated as if it requires _zero fuel_; the
/// remaining mass, if any, is instead handled by _wishing really hard_, which
